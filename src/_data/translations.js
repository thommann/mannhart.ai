export default {
  en: {
    ...
    about: {
      number: "01",
      title: "About",
      abstract: `<p>I'm a <strong>Professional AI Engineer</strong> at <a href="https://en.bbv.ch/" target="_blank" rel="noopener">bbv Software Services</a> in Zürich. Together with my team, I'm building the <a href="https://ai-hub.bbv.ch/" target="_blank" rel="noopener">Swiss AI Hub</a>, a Swiss-made, model-agnostic AI platform for organizations of any size. Beyond the platform, I design and implement custom AI solutions for our customers, with a focus on RAG systems and agentic workflows. I also serve as technical lead on customer AI projects and consult organizations on their AI strategy.</p>
<p>I studied Informatics at the <strong>University of Zürich</strong>. I did my Bachelor's in Software Systems and my Master's in Artificial Intelligence. Already during my Bachelor's, I started working as a software engineer. My first role was at swissbiomechanics, an ETH spin-off, where I independently built a Java application for tracking biomedical analyses. At PolygonSoftware, a startup founded by UZH graduates, I worked as a full-stack developer and led several customer projects. After finishing my Master's, I joined Ergon Informatik, one of Zürich's most respected software houses, where I worked on workforce planning software for the retail sector. From there, I moved to bbv, which offered me a position as an AI Engineer.</p>`,
      viewMore: "View more",
      viewLess: "View less",
...
<p>My <a href="#skills">technical toolkit</a> centres on Python, TypeScript, and Java/Kotlin, with deep experience in agent orchestration, RAG, and the Model Context Protocol. I'm fluent in German and English, and speak some French. And when I'm not coding — hot tea, cold beer, good food, thick books, old music, and long boardgame nights.</p>`,
  ...
  de: {
    ...
    about: {
      number: "01",
      title: "Über mich",
      abstract: `<p>Als <strong>Professional AI Engineer</strong> bei <a href="https://en.bbv.ch/" target="_blank" rel="noopener">bbv Software Services</a> in Zürich baue ich zusammen mit meinem Team den <a href="https://ai-hub.bbv.ch/" target="_blank" rel="noopener">Swiss AI Hub</a>, eine Schweizer, modell-agnostische KI-Plattform für Organisationen jeder Grösse. Neben der Plattform entwerfe und implementiere ich massgeschneiderte KI-Lösungen für unsere Kunden, mit Fokus auf RAG-Systeme und agentische Workflows. Zudem übernehme ich die technische Leitung von KI-Kundenprojekten und berate Organisationen bei ihrer KI-Strategie.</p>
<p>Informatik habe ich an der <strong>Universität Zürich</strong> studiert. Meinen Bachelor machte ich in Software Systems, den Master in Artificial Intelligence. Bereits während meines Bachelors begann ich als Software Engineer zu arbeiten. Meine erste Stelle war bei swissbiomechanics, einem ETH-Spin-off, wo ich eigenständig eine Java-Anwendung zur Nachverfolgung biomedizinischer Analysen entwickelte. Bei PolygonSoftware, einem von UZH-Absolventen gegründeten Startup, arbeitete ich als Full-Stack-Entwickler und leitete mehrere Kundenprojekte. Nach dem Master wechselte ich zu Ergon Informatik, einem der renommiertesten Softwarehäuser Zürichs, wo ich an Personalplanungssoftware für den Detailhandel arbeitete. Von dort wechselte ich zu bbv, wo mir die Stelle als AI Engineer angeboten wurde.</p>`,
