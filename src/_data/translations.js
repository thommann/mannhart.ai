...
<p>My <a href="#skills">technical toolkit</a> centres on Python, TypeScript, and Java/Kotlin, with deep experience in agent orchestration, RAG, and the Model Context Protocol. I'm fluent in German and English, and speak some French. And when I'm not coding — hot tea, cold beer, good food, thick books, old music, and long boardgame nights.</p>`,
      ...
      jobs: [
        {
          ...
          desc: [
            ...
            "Advising clients on developing and implementing their IT and AI strategy.",
        ...
        },
        {
          ...
          location: "Zürich, Switzerland",
          desc: [
            "Analysed, designed, and implemented software components for a retail workforce scheduling system, from requirements engineering and prototyping to third-level support.",
            "Wrote automated E2E tests and conducted code reviews.",
            "Mentored new team members and organized IT workshops for students.",
          ],
        ...
        },
        {
          ...
          desc: [
            "Developed web applications and computer vision / ML projects at a UZH-founded startup.",
            "Projects included an OCR pipeline for logistics and a data visualization app for vibration measurement.",
            "Designed software architectures and served as the primary interface to product owners and clients.",
          ],
        ...
        },
        {
          ...
          location: "Zürich, Switzerland",
          desc: [
            "Independently developed a Java application to track biomedical analyses and generate clinical reports.",
            "Led stakeholder communication, requirements analysis, and coordination with other developers.",
          ],
          tech: ["Java", "JavaFX"],
  ...
  de: {
    ...
    about: {
      number: "01",
      title: "Über mich",
      abstract: `<p>Als <strong>Professional AI Engineer</strong> bei <a href="https://en.bbv.ch/" target="_blank" rel="noopener">bbv Software Services</a> in Zürich baue ich zusammen mit meinem Team den <a href="https://ai-hub.bbv.ch/" target="_blank" rel="noopener">Swiss AI Hub</a>, eine Schweizer, modell-agnostische KI-Plattform für Organisationen jeder Grösse, und entwerfe massgeschneiderte KI-Lösungen für Kunden, mit Fokus auf RAG-Systeme und agentische Workflows. Zudem leite ich KI-Kundenprojekte als Dev Lead und berate bei der KI-Strategie.</p>
      ...
      jobs: [
        {
          ...
          desc: [
            ...
            "Beratung von Kunden bei der Erarbeitung und Umsetzung ihrer IT- und insbesondere KI-Strategie.",
        ...
        },
        {
          ...
          location: "Zürich, Schweiz",
          desc: [
            "Analyse, Design und Implementierung von Softwarekomponenten für ein Zeiterfassungs- und Personaleinsatzplanungssystem, von der Anforderungsanalyse und Prototyping bis zum Third-Level-Support.",
            "Erstellung automatisierter E2E-Tests und Code-Reviews.",
            "Mentoring neuer Teammitglieder und Durchführung von IT-Workshops für Schüler.",
          ],
          tech: ["Java", "Kotlin", "Angular", "TypeScript", "SQL", "PostgreSQL", "HTML / CSS", "Selenium", "Jenkins", "Gradle", "Git", "Bitbucket", "JIRA"],
        ...
        },
        {
          ...
          desc: [
            "Entwicklung von Webanwendungen sowie Computer-Vision- und ML-Projekten bei einem UZH-Startup.",
            "Projekte: u.\u00a0a. OCR-Pipeline für ein Logistikunternehmen und Datenvisualisierungsanwendung für Erschütterungsmessgeräte.",
            "Entwurf von Softwarearchitekturen und direkte Schnittstelle zu Product Owners und Kunden.",
          ],
          tech: ["Vue", "TypeScript", "Node.js", "Express", "GraphQL", "SQL", "AWS"],
        ...
        },
        {
          ...
          location: "Zürich, Schweiz",
          desc: [
            "Eigenständige Entwicklung einer Java-Anwendung zur Erfassung biomedizinischer Analysen und Erstellung klinischer Berichte.",
            "Verantwortlich für Stakeholder-Kommunikation, Anforderungsanalyse und Koordination mit anderen Entwicklern.",
          ],
          tech: ["Java", "JavaFX"],
