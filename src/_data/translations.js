export default {
  en: {
    ...
    hero: {
      ...
      desc: "Building enterprise AI in Zürich. I co-develop the Swiss AI Hub at bbv, design custom AI solutions, lead customer projects, and write about how AI is changing the way we build software.",
...
<p>My <a href="#skills">technical toolkit</a> centres on Python, TypeScript, and Java/Kotlin, with deep experience in agent orchestration, RAG, and the Model Context Protocol. I'm fluent in German and English, and speak some French. And when I'm not coding — hot tea, cold beer, good food, thick books, old music, and long boardgame nights.</p>`,
  ...
  de: {
    ...
    hero: {
      label: "Professional AI Engineer · Zürich, CH",
      name: 'Thomas<br>Rolf<br><em>Mannhart</em>',
      desc: "Ich entwickle Enterprise-KI in Zürich. Ich entwickle den Swiss AI Hub bei bbv mit, designe kundenspezifische KI-Lösungen, leite Kundenprojekte und schreibe darüber, wie KI die Softwareentwicklung verändert.",
